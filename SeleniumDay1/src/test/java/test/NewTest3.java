...
public class NewTest3 {
  ...
  public void testDragAndDrop() throws InterruptedException {
	  ...
	  WebElement from = driver.findElement(By.xpath
			  ("//div[@id='ctl00_ContentPlaceholder1_RadTreeView1']/ul/li/ul/li[3]/div/div/span")); 
	  
	  WebElement to = driver.findElement(By.xpath
			  ("//div[@id='ctl00_ContentPlaceholder1_priceChecker']/div[1]"));
	  ...
	  System.out.println("Price mesahe:" +pricemessage );
